...
ต้องคำนวณจำนวน Secret files แยกตาม hierarchy node ที่ผู้ใช้เห็น เช่น EVP, Department, Group และ Project เพื่อใช้พิสูจน์ authorization, filter และ reconciliation
